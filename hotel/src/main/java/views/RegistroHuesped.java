...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(Integer reservaId) {
	    ...
	    // Puedes usar la variable reservaId en la inicialización si es necesario
	}
	...
	private void guardarHuespedes() {
	    try {
	        ...
	        Date fechaNacimiento = new Date(txtFechaN.getDate().getTime()); // Convertir la fecha del JDateChooser a java.sql.Date
	        String nacionalidad = txtNacionalidad.getSelectedItem().toString();
	        String telefono = txtTelefono.getText();
	        Integer idReserva = Integer.parseInt(txtNreserva.getText()); // Obtener el ID de reserva como entero

	        // Crear un objeto Huespedes con los datos recopilados
	        Huespedes nuevoHuesped = new Huespedes(nombre, apellido, fechaNacimiento, nacionalidad, telefono, idReserva);
	        
	        HuespedesController huesped = new HuespedesController();
	        // Llamar al controlador para guardar el huésped en la base de datos
	        huesped.guardar(nuevoHuesped);

	        // Mostrar un mensaje de éxito
	        JOptionPane.showMessageDialog(null, "Huésped guardado con éxito.");
	        
	     // Crear una instancia del frame Exito y hacerlo visible
	        ...
	        e.printStackTrace();
	        JOptionPane.showMessageDialog(null, "Error al guardar el huésped.");
	    }
	}
